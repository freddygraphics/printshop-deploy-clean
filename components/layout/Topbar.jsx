  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b shadow-sm z-50">
      <div className="h-full flex items-center">
        {/* LEFT: Sidebar space (brand stays here) */}
        ...
        {/* RIGHT: Board area (search + icons + profile centered) */}
        <div className="flex-1 px-6">
          <div className="h-full max-w-[1400px] mx-auto flex items-center">
            {/* LEFT inside board: Search */}
            <div className="flex items-center gap-3">
              {/* Mobile menu (only if you want it inside board) */}
              <button
            ...
            {/* CENTER inside board: Quick actions */}
